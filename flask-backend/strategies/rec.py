...
def greatest_price_percentage_change_24h():
    ...
    save_log(sorted_df,folder="/Users/bp/Documents/crypto_site/crypto-site/flask-backend/data/logs",base_name="percentage_change_24h_log")
...
def greatest_volume_24h():
    ...
    save_log(sorted_df,folder="/Users/bp/Documents/crypto_site/crypto-site/flask-backend/data/logs",base_name="volume_24h_log")
